...
📦 **Project Application:** [Download cic-dev-scripting.zip](../Project-States/starting-point/cic-dev-scripting.zip)(Right click to open in new tab)  
📦 **Supporting Files:** [Download cic-dev-upload-examples.zip](../Project-States/claim-upload-docs/cic-dev-upload-examples.zip)(Right click to open in new tab)  
