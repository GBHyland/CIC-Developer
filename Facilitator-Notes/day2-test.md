...
> **Lab Formatting**
>
> Fenced code blocks with a **Copy** button contain code or commands you are expected to copy into your development files or terminal. Reference examples, expected results, diagrams, and file locations use labeled callouts instead.
...
> **EXAMPLE**
>
> <pre>Insurance Claims Dashboard
...
> **HOW IT WORKS**
>
> <pre>libs/dashboard/customDashComponent.ts</pre>
...
> <pre>SELECT *
FROM SysFolder
WHERE sys_parentPath = &#x27;/uidev_claims&#x27;</pre>
...
> **REFERENCE**
>
> <pre>WHERE sys_parentPath = &#x27;/uidev_claims&#x27;</pre>
...
> **EXPECTED RESULT**
>
> <pre>libs/dashboard/customDashComponent.html</pre>
...
> **EXPECTED RESULT**
>
> <pre>customDashComponent.ts</pre>
...
> **EXPECTED RESULT**
>
> <pre>/uidev_claims/CLM-10001</pre>
...
loadClaimDocuments()
    → Finds documents inside one claim</pre>
...
> **FILE / LOCATION**
>
> <pre>customDashComponent.html</pre>
...
> **FILE / LOCATION**
>
> <pre>customDashComponent.scss</pre>
...
> **FILE / LOCATION**
>
> <pre>http://localhost:4200/#/dashboard</pre>
...
> **EXPECTED RESULT**
>
> <pre>Angular loads customDashComponent
            │
            ▼
         ngOnInit()
            │
...
> **REFERENCE**
>
> <pre>private queryApi = inject&lt;QueryApi&gt;(QUERY_API_TOKEN);</pre>
...
> <pre>SELECT *
FROM SysContent
WHERE sys_parentPath = &#x27;/uidev_claims/CLAIM&#x27;</pre>
